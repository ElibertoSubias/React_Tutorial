...
const Dropzone = () => {
    ...
    const onDropRejected = () => {
        mostrarAlerta("No se pudo subir, el limite es de 1MB, obten una cuenta gratis para subir archivos más grandes.");
    }
    ...
    return ( 
        <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0 flex flex-col items-center justify-center border-dashed border-gray-400 border-2 border-gray-100 px-4">
